-- MySQL SCHEMA - Kyle Harrison and Candice Stewart
--
...
CREATE SCHEMA IF NOT EXISTS tbnc;
...
CREATE TABLE IF NOT EXISTS VoucherSchemeProvider (
 	VoucherSchemeProviderId 	int NOT NULL AUTO_INCREMENT,
...
-- Table structure for table MonthlyInvoice
 CREATE TABLE IF NOT EXISTS MonthlyInvoice (
	...
	DaysOverdue					int(11) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS VoucherSchemeRegister (
 	VoucherSchemeID             int NOT NULL AUTO_INCREMENT,
 	VoucherSchemeProviderId 	int NOT NULL,
 	ChildID                     int NOT NULL,
 	ParentID                    int NOT NULL,
