-- MySQL 
--
-- Host: 127.0.0.1   		 Database: TeddyBearNurseryClub
-- User:					 Password:
-- ------------------------------------------------------
-- Tested on Server version	5.5.27 - MySQL Community Server 
-- REFERENCE http://dev.mysql.com/doc/refman/4.1/en/innodb-foreign-key-constraints.html

CREATE SCHEMA IF NOT EXISTS TeddyBearNurseryClub;

USE TeddyBearNurseryClub;
...
--	
 CREATE TABLE IF NOT EXISTS Room (
	RoomName     				enum('Baby Room', 'Polar Room', 'Panda Room', 'Teddy’s Transformers', 'Daisy’s Discoverers', 'Oakley’s Explorers',"None") NOT NULL DEFAULT 'None',
 	...
 	RoomVacancy  				tinyint NOT NULL DEFAULT 0,
...
--	
 CREATE TABLE IF NOT EXISTS Attendance (
 	...
 	Teas         				tinyint NOT NULL DEFAULT 0,
